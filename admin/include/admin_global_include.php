...
function adminNavigation() {
    ...
    <a id = "report" href = "reports.php"><img class = "menuImages" src = "http://localhost/dict/images/menu/lightning.png" width = "24px" height = " height="22px"> Reports</a>
                <a id="log" href="#"><img class="menuImages" src="http://localhost/dict/images/dict_logo.png" width="24px" height="24px"> Logs</a>
