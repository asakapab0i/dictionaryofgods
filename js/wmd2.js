...
Attacklab.wmdBase = function(){
	...
	wmd.PanelCollection = function(){
		this.buttonBar = doc.getElementById("wmd-button-bar2");
		this.preview = doc.getElementById("wmd-preview2");
		this.output = doc.getElementById("wmd-output2");
		this.input = doc.getElementById("wmd-input2");
	};
